...
function lenthString(){
    var Name:string="Allah is the best planner";
...
// function copyString(){
//    var str:string="Allah is the best planner";
//    var   now=str;
...
// function coMpare(){
//    var com:string="This is beautifull";
...
// function loWer(){
//    var cAse:String="we are  muslims";
...
// } 
//    var character1:string="People are Effected by flood";
//   var result= voWel(character1)
//     console.log(`These are vowel letter ${result} and others are consonent`)

// // 10. Write a ts program to count total number of words in a string.

// function count(){
//    var cOunt:string="we are Muslim";
...
// function occurrence(){
//    var str:string="Typescript is a great language"
...
// function oCCur(){
//    var chrac:string="we are intelligent";
...
//       }
//    }
//    console.log(`Words occur are: ${chrac} => ${letter} : ${count} `)
// }
// cHar();
...
// function lReplace(){
//    var re:string="go";
//    var fiRst:string="where are you go";
...
// function allReplace(){
//    var re=/apple/gi;
//    var fiRst:string="apple are  round and apple are jusicy";
...
//    var iRst:string="Allah is best Planner";
...
// function tRim(){
//    var trim:string="   I am Peter Parker";

//    var str:string=trim.trimStart()
...
// function eXtra(){
//    var extra:string="I am boy";

//   //var str:string = extra.replaceAll(" ",""); 
...
// function maxTwo(num1:number, num2:number)
// {
//    if(num1>num2){
...
// function maxThree(num1:number, num2:number, num3:number)
// {
...
// function mOnth(number:number){
 
//    switch(number){
//       case 1:console.log("Month is January and its days are 31")
//       break;
//       case 2:console.log("Month is Feburary and its days are 28")
//       break;
//       case 3:console.log("Month is  March and its days are 31")
//       break;
//       case 4:console.log("Month is  April and its days are 30")
//       break;
//       case 5:console.log("Month is  MAy and its days are 31")
//       break;
//       case 6:console.log("Month is June and its days are 30")
//       break;
//       case 7:console.log("Month is July and its days are 31")
//       break;
//       case 8:console.log("Month is August and its days are 31")
//       break;
//       case 9:console.log("Month is September and its days are 30")
//       break;
//       case 10:console.log("Month is October and its days are 31")
//       break;
//       case 11:console.log("Month is November and its days are 30")
//       break;
//       case 12:console.log("Month is December and its days are 31")
//       break;
//       default:console.log("unknown Value! Enete the valid  number")
//       break;
//    }
...
// function cOnsonent(str:string){
 
//    switch(true){
//       case(str== "" ):console.log("Alphabet is vowel or consonent")
//       break;
//       case (str==""):console.log("Alphabet is consonent")
//       break;
//    }
...
// function maXnum(numi:number, numi2:number){
//    switch(true){
//       case (numi>numi2):console.log(`${numi} is a Maximun Number`)
//       break;
//       case (numi2>numi):console.log(`${numi2} is a Maximum Number`)
...
// function oDDnum(numi:number){
//    switch(true){
//       case (numi%2==0):console.log(`${numi} is a Even Number`)
//       break;
//       case (numi%2!=0):console.log(`${numi} is a Odd Number`)
...
// function pOsnum(numi:number){
//    switch(true){
//       case (numi>0):console.log(`${numi} is a Positive  Number`)
//       break;
//       case (numi<0):console.log(`${numi} is a Negative Number`)
//       break;
//       case(numi==0):console.log(`Is a zero`)
//       break;
...
//    switch(true){
//       case(d>0):console.log("Roots are real and different :" , (-b+e)/(2*a) + " and " + (-b - e) / (2 * a));
//       break;

//       case(d<0):console.log("Roots are complex")
//       console.log(-b / (2 * a), "i" , e/ (2 * a) , '<br>',-b / (2 * a), "i" ,e/ (2 * a) )
//       break;

//       case(d==0):console.log("Roots are same" , -b / (2 * a) , " and " , -b / (2 * a))
//       break;


//       default:console.log("Enter the valid values")
//       break;
...
// function cAlcu(nume:number, nume2:number, operrator){
...
//       case ('+'):  resul = nume + nume2;
//       console.log((`${nume} ${operrator} ${nume2}= ${resul}`))
//       break;
//       case  ('*'): resul = nume * nume2;
//           console.log((`${nume} ${operrator} ${nume2}= ${resul}`))
//       break;
